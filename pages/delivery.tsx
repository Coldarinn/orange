...
export default function Delivery() {
  const [selected, setSelected] = useState<{ id: number, city: string }>({ id: 0, city: 'Москва' });
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap gap-[16px] mb-[40px]">
            {Array.from({ length: showAll ? 85 : 9 }).map((_, idx) => (
              <button
                type="button"
                className={`px-[16px] py-[12px] hover:opacity-60 rounded-[22px] transition duration-300 ${selected.id === idx ? 'text-white bg-brand-700' : 'text-text-700 bg-white'}`}
          ...
          <div className="flex items-start">
            <div className="w-[636px] basis-[636px] bg-white border border-stroke-dark rounded-[32px] p-[32px] mr-[36px]">
              ...
              <p className="text-text-700 mb-[24px]">
                Срок доставки, а также способ оплаты и условия
                хранения зависят от конкретного пункта выдачи
              </p>
